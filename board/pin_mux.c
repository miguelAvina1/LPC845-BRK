...
- pin_list:
  ...
  - {pin_num: '13', peripheral: I2C0, signal: SCL, pin_signal: PIO0_10/I2C0_SCL, i2cmode: fastMode}
  ...
  - {pin_num: '1', peripheral: CAPT, signal: CAPTYL, pin_signal: PIO1_8/CAPT_YL}
  - {pin_num: '3', peripheral: CAPT, signal: CAPTYH, pin_signal: PIO1_9/CAPT_YH}
  - {pin_num: '42', peripheral: GPIO, signal: 'PIO0, 30', pin_signal: PIO0_30/ACMP_I5}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitSWD_DEBUGPins(void)
{
	...
	IOCON->PIO[8] = ((IOCON->PIO[8] &
			...
			/* Selects I2C mode.: Standard mode/ Fast-mode I2C. */
			| IOCON_PIO_I2CMODE(PIO0_10_I2CMODE_STANDARAD_I2C));
