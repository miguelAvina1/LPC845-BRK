...
outputs:
- {id: CAPT_clock.outFreq, value: 18 MHz}
...
- {id: SYSCON.CAPTCLKSEL.sel, value: SYSCON.FRO_DIRECT}
...
- {id: SYSCON.I2C0CLKSEL.sel, value: SYSCON.FRO_DIRECT}
...
void BOARD_BootClockFRO18M(void)
{
    ...
    CLOCK_Select(kCAPT_Clk_From_Fro);                       /*!< select FRO for CAPT */
    CLOCK_Select(kI2C0_Clk_From_Fro);                      /*!< select FRO for I2C0 */
